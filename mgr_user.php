  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="height: 40px; text-align: right;">
      	<input type="button" name="btnAdd" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; เพิ่ม &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" onClick="window.location='add_user.php?m=add';" />
      	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </td>
      <td>&nbsp;</td>
    </tr>
...
$query_rsmem = "
	...
	WHERE a.l_id = b.l_id and a.staff_id = '3' and a.user_status = '1' and a.l_id = '".$_SESSION["s_limit_id"]."'
	ORDER BY a.user_id
";
//echo $query_rsmem;
//break;
...
<tr style="background-color: #<?php echo $color02; ?>;">
        ...
        <td>
        	<div align="center">
        		<a href="#">
        			<img src="images/28.png" width="16" height="16" onClick="window.location='add_user.php?m=edit&id=<?php echo $row_rsmem["user_id"]; ?>';">
        		</a>
        	</div>
        </td>
        <td>
        	<div align="center">
        		<a href="#">
        			<img src="images/12.png" width="16" height="16" onClick="if(confirm('ยืนยันการลบ?')){ window.location='p_add_user.php?m=delete&id=<?php echo $row_rsmem["user_id"]; ?>'; }">
        		</a>
        	</div>
        </td>
</tr>
