...
if(isset($_POST["txtMode"]) && $_POST["txtMode"]=='add'){
	...
	{		
		...
		if($row_email["user_id"] <> ""){
			...
			VALUES ( '".$_POST["txtIdCard"]."', '1', '".$_POST["ddlTitle"]."', '".$_POST["txtName"]."', 
			...
			echo "<meta  http-equiv='refresh' content='0;url=mgr_super.php'>";
		}
	...
	if($_POST["txtPass"] <> $_POST["txtPass2"]){
		...
		echo "<meta  http-equiv='refresh' content='1;url=mgr_super.php'>";
}else{
