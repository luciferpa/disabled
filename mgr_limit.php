  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="height: 40px; text-align: right;">
      	<input type="button" name="btnAdd" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; เพิ่ม &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" onClick="window.location='add_limit.php?m=add';" />
      	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </td>
      <td>&nbsp;</td>
    </tr>
...
$startRow_rsmem = $pageNum_rsmem * $maxRows_rsmem;
//คิวรี่ปกติ
$query_rsmem = " select * from tb_limit where l_status ='1' order by l_id ";
//echo $query_rsmem;
//break;
...
?>
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
      <tr style="background-color: #4F91CD;color: #FFFFFF;">
        <th  height="30px" width="32%"><div align="center">รหัสสำนักงานเขต</div></th>
        <th width="57%"><div align="center">ชื่อสำนักงานเขต</div></th>
...
<tr style="background-color: #<?php echo $color02; ?>;">
        <td height="30px"><?php echo $row_rsmem["l_code"]; ?></td>
        <td ><?php echo $row_rsmem["l_name"]; ?></td>
        <td>
        	<div align="center">
        		<a href="#">
        			<img src="images/28.png" width="16" height="16" onClick="window.location='add_limit.php?m=edit&id=<?php echo $row_rsmem["l_id"]; ?>';">
        		</a>
        	</div>
        </td>
        <td><div align="center"><a href="#"><img src="images/12.png" width="16" height="16" onClick="if(confirm('ยืนยันการลบ?')){ window.location='p_add_limit.php?m=delete&id=<?php echo $row_rsmem["l_id"]; ?>'; }"></a></div></td>
</tr>
