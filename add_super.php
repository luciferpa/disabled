...
if(isset($_GET['id'])){  
	...
	$query = "
		...
		WHERE a.l_id = b.l_id and a.staff_id = '1' and a.user_status = '1' and a.user_id = '".$_GET['id']."'
	";
	//echo $query;
	//break;
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tbody>
    ...
    <tr>
      <td>&nbsp;</td>
      <td style="text-align: center;"><h2>จัดการ Super Admin</h2></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
...
<form name="form1" method="post" action="p_add_super.php">      
...
?>
          ...
          <tr>
            <td height="40">รหัสกลุ่มงาน :</td>
            <td>
				<select name="ddlLimit" style="height: 30px; width: 250px">
<?php
	$query = "
		SELECT * 
		FROM tb_limit a
	...
	//break;
	$result = mysql_db_query($dbname, $query); 
	while($row_limit = mysql_fetch_array($result)){
		$flaq01 = "";
		if(isset($_GET['id'])){ 
			if($row["l_id"]==$row_limit["l_id"]){
				$flaq01 = "selected";
			}
		}
?>
					  <option value="<?php echo $row_limit["l_id"]; ?>" <?php echo $flaq01; ?>><?php echo $row_limit["l_code"].' '.$row_limit["l_name"]; ?></option>
<?php
    }
?>
				</select>
          ...
          <tr>
            <td colspan="2"><div align="center">
              ...
              &nbsp;&nbsp;&nbsp;
              <input type="reset" name="btnReset" value="  ยกเลิก  " onClick="window.location='mgr_super.php';">
