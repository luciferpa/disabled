...
if(isset($_GET['id'])){  
	...
	$query = "
		...
		WHERE a.l_id = b.l_id and a.staff_id = '2' and a.user_status = '1' and a.user_id = '".$_GET['id']."'
	";
	//echo $query;
	//break;
...
<form name="form1" method="post" action="p_add_admin.php">      
...
?>
          ...
          <tr>
            <td colspan="2"><div align="center">
              ...
              &nbsp;&nbsp;&nbsp;
              <input type="reset" name="btnReset" value="  ยกเลิก  " onClick="window.location='mgr_admin.php';">
