...
if(isset($_POST["txtMode"]) && $_POST["txtMode"]=='add'){
	...
	{		
		...
		if($row_email["user_id"] <> ""){
			...
			VALUES ( '".$_POST["txtIdCard"]."', '3', '".$_POST["ddlTitle"]."', '".$_POST["txtName"]."', 
			'".$_POST["txtSurName"]."', '".$_SESSION["s_limit_id"]."', '".$_POST["txtTel"]."', '".$_POST["txtEmail"]."',
			'".$_POST["txtPass"]."', '1' )";
			//echo $query;
			//break;
			$result = mysql_db_query($dbname, $query); 	
			...
			echo "<meta  http-equiv='refresh' content='0;url=mgr_user.php'>";
		}
	...
	if($_POST["txtPass"] <> $_POST["txtPass2"]){
		...
		echo "<meta  http-equiv='refresh' content='1;url=mgr_user.php'>";
}else{
